...
//			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,40,15,1,1,2.5f,g.getSkill(9), true, 2, 0, this, 1, collisionLayer));	//eisschild
			...
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,1,1,1,3,g.getSkill(0), false, 0, 0, this, 10, collisionLayer));	//auto-attack
			
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,1,1,g.getSkill(0), false, 1, 0, this, 10, collisionLayer));// 3-fach dolch
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,0.9f,1.5f,g.getSkill(0), false, 1, 0, this, 10, collisionLayer)); 
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,0.8f,2,g.getSkill(0), false, 1, 0, this, 10, collisionLayer));
...
//			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,1,2,1,1,10,g.getSkill(10), true, 2, 0, this, 1, collisionLayer));	//tempo+
			...
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,30,3,1,1,3,g.getSkill(1), false, 3, 0, this, 10, collisionLayer));	//giftdolchwurf
			
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,50,15,1,1,3,g.getSkill(2), false, 4, 1, this, 10, collisionLayer));	//dolchfächer 
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,50,15,1,1,3,g.getSkill(2), false, 4, 2, this, 10, collisionLayer));
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,50,15,1,1,3,g.getSkill(2), false, 4, 3, this, 10, collisionLayer));
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,50,15,1,1,3,g.getSkill(2), false, 4, 4, this, 10, collisionLayer));
		}
		else if(c instanceof Schuetze){
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,1,1,1,2,g.getSkill(0), false, 0, 0, this, 10, collisionLayer));//auto-attack
			
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,1,1,g.getSkill(0), false, 1, 0, this, 10, collisionLayer));// 3-fach pfeil
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,0.9f,1.5f,g.getSkill(0), false, 1, 0, this, 10, collisionLayer));
			getSkills().add(new Skill(this.getPosition().x, this.getPosition().y, 1,10,3,1,0.8f,2,g.getSkill(0), false, 1, 0, this, 10, collisionLayer));
