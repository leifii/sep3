...
//	}
	...
	for (int i = 0; i < keys.length; i++) {
		...
		keys[0].setPosition(ps.c.position.x-100, ps.c.position.y+40);
		keys[1].setPosition(ps.c.position.x, ps.c.position.y+40);
		keys[2].setPosition(ps.c.position.x+100, ps.c.position.y+40);
		keys[i].draw(sb);
	}
