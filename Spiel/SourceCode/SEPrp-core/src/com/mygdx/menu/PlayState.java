...
public class PlayState extends State implements Serializable {
	...
	public PlayState(GameStateManager gsm, int characterauswahl, int design) {
		...
		Npc = new NPC[]{new NPC(120, 300, "grafiken/Kobold.png","*TutorialNPC*:"+"Hallo[name]! Ich erkläre dir wie das Spiel funktioniert. WASD:Laufen, 1234: Skills, Leertaste: Angreifen/Interagieren, I:Inventar", createDynamicBody(120,300,"npc")),
